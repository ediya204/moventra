...
import {retiredTeamPath,assertPersonalAction} from '../../packages/shared/src/portal/personalV1.ts';
import {initialState,transition,financeTransition} from '../../apps/client/src/portal/model.ts';
