...
核对日期：2026-09-18。状态：本地实现及隔离测试通过，API与两端代码已发布；未安装生产016或启用人工资金，未执行正式入账或真实刷卡。基线为 Moventra main `1ed842adc1abd530dd32f5c123c277d40b41c633` 加本批未提交增量，保留其他任务改动。
...
| 016迁移、最小权限、独立审批人与Worker | 工程/授权运营，上线前 | 代码已部署，016/权限/执行Worker未配置 |
