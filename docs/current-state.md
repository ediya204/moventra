...
014 已于香港17:47迁移生产。开卡代码已在独立发布目录整理，116项前端测试、两端类型检查/构建及隔离PG race通过；价格已获用户确认开卡费10 USD、最低首充20 USD。部署及目录实际结果以[本次发布记录](../deploy/2026-09-18-client-issuing-release.md)为准。真实金融执行尚未开放，不能将目录上架当作可支付。
