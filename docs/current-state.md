...
新增017、通知回查发布当前状态、正式归属卡片定时补查、详情手动核对、前后台共同状态及同步时间。原导入和归属保持独立，交易和资金未扩展。本批未设置每卡10美元，亦未新增CVV。23张卡全部已真实核验：14正常、9暂停；第二轮定时补查已实际运行。API最终cfdd45f已live，前后台已发布；自动化与上线证据见[同步发布](../deploy/2026-09-18-card-state-sync.md)。
