...
const patch={
 authorizedDomains:[...new Set([...(current.authorizedDomains || []),'moventra.me','www.moventra.me','admin.moventra.me','moventra.apexisnetworking.work','admin.moventra.apexisnetworking.work','localhost'])],
