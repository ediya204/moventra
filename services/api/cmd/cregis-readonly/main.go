...
func main() {
	...
	if e = json.NewEncoder(os.Stdout).Encode(map[string]any{"provider": "cregis_waas", "page": p.Page, "pageSize": p.PageSize, "total": p.Total.String(), "received": len(p.Rows), "scope": "project_history_page"}); e != nil {
		os.Exit(1)
	}
}
