...
新增独立渠道投影、显式渠道读取权限和MFA校验，详情见 [发布及导入说明](../../docs/releases/channel-projection-2026-09-07.md)。用户授权本轮迁移002及手动导入，不新增客户资金分录或在线上保存Slash凭据。上文“未接入卡渠道”以本增量为准；不代表真实金融写能力。
