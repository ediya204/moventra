...
export default function CryptoFundsPage(){
 ...
 return <DashboardLayout production><Stack spacing={3}><Typography variant="h4">{kind==='otc'?'OTC 兑换管理':kind==='withdrawal'?'数字货币出金审批':'数字货币流水'}</Typography><Stack direction="row"><Button component={Link} to="/system/cregis">渠道观察与同步</Button></Stack>
