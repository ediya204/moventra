...
function ChannelContent(){
 ...
 return <DashboardLayout production><Stack gap={2.5}><Stack direction="row" justifyContent="space-between"><Box><Typography variant="h4">{id?'卡片详情':'卡交易流水'}</Typography><Typography color="text.secondary" sx={{mt:1}}>Slash · 真实只读记录</Typography></Box><Button disabled={busy} onClick={()=>setRefresh(n=>n+1)}>刷新已导入数据</Button></Stack>
