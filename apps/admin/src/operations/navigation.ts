...
export function isProductionPath(path: string) {
  return ['/card-bins', '/finance/test-funds', '/workbench', '/onboarding', '/user-groups/users', '/cards', '/customers', '/system/channels', '/transactions', '/session?security=1'].includes(path);
}
